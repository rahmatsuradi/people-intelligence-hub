...
1. Kalau "Budaya & nilai" di PROFIL PERUSAHAAN terisi, PECAH jadi poin-poin nilai/budaya spesifik (bukan dibaca sebagai satu kalimat generik), lalu jadikan BAHAN ide — bukan disebut ulang mentah-mentah sebagai teks, tapi diterjemahkan jadi ADEGAN/AKSI KONKRET yang MENUNJUKKAN nilai itu. Contoh SALAH: caption "Kami perusahaan yang kekeluargaan". Contoh BENAR: adegan konkret yang membuktikan kekeluargaan itu nyata (makan siang bareng semua level jabatan, dst — sesuaikan dengan nilai yang benar-benar disebutkan user). Minimal 2 ide harus jelas berakar dari satu poin budaya/nilai yang disebutkan user.
2. TREN VIRAL & TRENDING OTOMATIS adalah riset default. TAPI kalau TREN TAMBAHAN DARI USER terisi (nama orang, meme, momen viral spesifik, dll), itu WAJIB jadi anchor konkret untuk MINIMAL 2 ide — sebut entitasnya secara eksplisit di title & description (bukan cuma disinggung sepintas di trendReference), dan jelaskan persis bagaimana entitas/momen itu dihubungkan ke pesan employer branding di contentBreakdown. Kalau kosong, itu normal, pakai TREN OTOMATIS sepenuhnya.
3. Buat ${ideaCountLabel} ide konten dengan tingkat kekonkretan seperti CONTOH STANDAR KUALITAS di atas. Setiap ide WAJIB relevan dengan companyContext yang sudah kamu tulis (industri & situasi nyata perusahaan ini, bukan generik untuk industri manapun), dan WAJIB memakai format berbeda dari daftar FORMAT VIRAL (boleh dimodifikasi, sebutkan nama format aslinya + platform di "formatUsed")
4. Untuk SETIAP ide video/reel/story/live-session/podcast-clip, buat "contentBreakdown": array 5-8 beat yang MENCAKUP DURASI PENUH sesuai kerangka format yang dipilih — kalau formatnya berdurasi ~60 detik (mis. GRWM, Day in the Life), breakdown HARUS berjalan sampai kira-kira 0:50-1:00, BUKAN berhenti di 0:08-0:10 saja. Total durasi wajib proporsional dengan format (umumnya 20-60 detik untuk konten short-form, ikuti kerangka beat dari FORMAT VIRAL yang dipilih). Untuk carousel/infographic/photo-post/article, pakai label "Slide 1".."Slide N" (4-8 slide) — bukan berbasis waktu. Setiap beat WAJIB memuat: (a) label waktu/slide, (b) nama beat singkat, (c) description berisi CONTOH DIALOG/TEKS-DI-LAYAR PERSIS yang muncul DAN nama teknik visual/transisi spesifik (mis. jump cut, morph/aging filter, split-screen, freeze-frame, whip pan, voice-over reveal). DILARANG deskripsi abstrak seperti "buka dengan hook menarik" tanpa isi konkret — description minimal 15 kata dan harus terbaca seperti instruksi shot-list yang bisa langsung dieksekusi kru produksi
5. Minimal 2 dari ${ideaCountLabel} ide WAJIB menggabungkan SATU data/fakta spesifik perusahaan (masa kerja karyawan, jabatan, pencapaian) dengan SATU mekanik/efek visual yang sedang tren (age filter, freeze-frame reveal, split-screen before-after, morph cut, voice reveal, dll) — bukan sekadar format wawancara/testimoni polos
6. visualDirection, copyGuideline, productionNotes, dan contentBreakdown WAJIB berbeda-beda kalimatnya di setiap ide sesuai konten spesifiknya — DILARANG KERAS memakai kalimat yang sama persis di lebih dari satu ide
7. Setiap ide menerapkan minimal 1-3 KUNCI VIRAL & ENGAGEMENT — sebutkan di "viralPrinciples"
8. Untuk setiap ide, tulis juga "performancePattern": pola kualitatif kenapa konten sejenis biasanya berkinerja baik (rujuk ke kunci viral & engagement) — JANGAN mengarang angka/statistik spesifik seolah itu data nyata
9. Untuk setiap ide, tulis "variations": 2 variasi eksekusi/sudut pandang alternatif dari ide inti yang sama, supaya user punya beberapa opsi bukan cuma satu
10. Jika ada REFERENSI KONTEN dari user (link/video/catatan), WAJIB buat minimal 1 ide yang menerapkan metode Amati-Tiru-Modifikasi (ATM) darinya secara konkret — sebutkan persis pola/hook yang diamati di description, dan detail eksekusi modifikasinya di contentBreakdown. Jangan sekadar menyebut nama trennya tanpa menerjemahkan ke eksekusi nyata
11. Isi "sourceUrl" dengan URL PERSIS dari daftar TREN VIRAL & TRENDING OTOMATIS di atas kalau ide tsb merujuk padanya — SALIN PERSIS, JANGAN PERNAH mengarang/mengubah URL. Kalau tidak ada yang relevan atau tidak ada URL di daftar, kosongkan ("")
12. Buat editorial plan 4 minggu (tema per minggu, 3-5 post per minggu)
13. Semua konten harus relevan dengan konteks perusahaan Indonesia
14. Hashtag campuran Bahasa Indonesia dan Inggris
15. Pastikan variasi antar pilar, platform, dan tipe konten
16. Jika ada posisi terbuka, beberapa ide harus mengarah ke talent acquisition
