...
/* ═══════════════════════════════════════════════════════════════════════════
   Laporan hasil asesmen — tampilan untuk HR.

   Urutan halaman disusun mengikuti cara laporan asesmen korporat dibaca:
   1. Ringkasan eksekutif          — kesimpulan lebih dulu
   2. Kualitas jawaban             — boleh/tidaknya angka di bawah dipercaya
   3. Kesesuaian jabatan           — jawaban atas "cocok untuk posisi ini?"
   4. Profil skor per skala        — angkanya
   5. Interpretasi + probe wawancara — apa artinya & apa yang harus ditanyakan
   6. Batasan penggunaan           — selalu ikut tercetak
              ...
              {report.fit.criticalFlags.length > 0 && (
                <div className="mt-4 rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-500/30 dark:bg-red-500/10">
                  <p className="text-sm font-semibold text-red-800 dark:text-red-300">
                    Di bawah ambang kritis posisi ini
                  </p>
...
/* ─── Kelompok skor dengan batang sten ─── */
